...
const ListingDetails = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await fetch("https://airbnb-production-8011.up.railway.app/bookings/create", {
        method: "POST",
        headers: {
    ...
    <>
      ...
      <div className="listing-details">
        ...
        <div className="profile">
          <img
            src={`https://airbnb-production-8011.up.railway.app/${listing.creator.profileImagePath.replace(
              "public",
              ""
            )}`}
